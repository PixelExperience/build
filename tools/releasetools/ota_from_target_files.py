...
def main(argv):
  ...
  if OPTIONS.extracted_input is not None:
    ...
    logger.info("unzipping target target-files..." if OPTIONS.incremental_block_based else None)
  ...
  # Generate an incremental OTA.
    ...
    OPTIONS.source_tmp = common.UnzipTemp(
        OPTIONS.incremental_source, UNZIP_PATTERN if OPTIONS.incremental_block_based else None)
    with zipfile.ZipFile(args[0], 'r') as input_zip, \
